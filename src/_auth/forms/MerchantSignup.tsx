...
const formSchema = z.object({
    ...
    location: z.union([z.string().array().max(2), z.string({ required_error: "address is required." })]),
})
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-[80%] sm:w-[35%]">
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <Select onValueChange={field.onChange} >
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        <SelectItem value="currentLocation">Use Current Location</SelectItem>
                            ...
                            </Select>
                            {
                                field.value !== "currentLocation" && (
                                    <>
                                        <FormControl>
                                            <Input placeholder="Enter your address" type="string" onChange={(e) => field.onChange(e)} />
                                        </FormControl>
                                        <FormMessage />
                                    </>
                                )
                ...
                <p className="mt-2 text-sm font-thin">
                    ...
                    <Link to="/signin" className="text-green-600 text-xl ml-2 underline font-semibold">
                        Signin
                    </Link>
                </p>
            </form>
