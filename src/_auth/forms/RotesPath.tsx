...
export default function RoutesPath() {
  ...
  return (
    <div className="w-full max-w-[80%] mx-auto overflow-x-auto ">
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit(onSubmit)}
          // className="w-full max-w-[80%] sm:w-[35%] mx-auto"
        >
          <FormField
            name="source"
            render={({ field }) => (
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="mt-2">
                ...
                <FormControl className="relative overflow-auto">
                  <div className="max-w-lg mx-auto">
                    ...
                    >
                      <FormItem>
                        ...
                        <Label
                          htmlFor="bicycle"
                          className="flex flex-col w-20 items-center overflow-hidden justify-between rounded-md border-2 border-muted bg-popover p-2 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
                        >
                          <img
                            src={bicycle}
                            alt="bicycle"
